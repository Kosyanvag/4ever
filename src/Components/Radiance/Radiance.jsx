    ...
    <div className="Radiance">
      <div className="Radiance__content">
        <div className="Radiance__content-title">
          ...
          <h1>Гор & Амалия</h1>
          <p>
            Мы хотим разделить этот день с Вами - нашими близкими и родными
            людьми.
          </p>
          ...
          <p>
            Мы рады сообщить Вам, что 11 ноября состоится самое главное
            торжество в нашей жизни - день нашей свадьбы! <br /> <br />{" "}
        ...
        <div className="Radiance__content-day">
          ...
          <h3>
            Triumph Event Hall <br /> ул. Неверовского, 15
          </h3>
          <button>
            <a href="https://yandex.com/maps/-/CDdAy85X">Как добраться</a>
          </button>
          <h2>Dresscode</h2>
          <p>
          ...
          <h2>Девушки</h2>
          <p>
            Вы будете великолепно смотреться в коктельных платьях пастельных
            оттенков
          </p>
        ...
        <div className="Radiance__content-contact">
          ...
          <h2>
            "Любовь - это единственное чувство, которое растет, делясь с
            другими"{" "}
          </h2>
